...
export const WelcomeWavesBottomLeft: React.FC = () => {
  const [color] = useToken("colors", ["primary.900"]);
  return (
    <Icon
      position="absolute"
      bottom={{ sPc: "-100px", sMob: 0 }}
      left={0}
      width={{
        lPc: "762px",
        sPc: "542px",
    ...
    >
      <path
        ...
        fill="url(#paint0_linear_875_923)"
        fillOpacity="0.5"
      />
      <defs>
        <linearGradient
          id="paint0_linear_875_923"
          x1="1.19221e-05"
          y1="161.5"
          x2="632"
          y2="318.5"
        ...
        >
          <stop stopColor="var(--chakra-colors-primary-100)" />
          <stop offset="1" stopColor="var(--chakra-colors-primary-500)" />
        </linearGradient>
      </defs>
    </Icon>
  );

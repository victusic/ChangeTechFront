...
export function BrandColorsExample() {
  return (
    <Box>
      <Box bg="brand.50" p={4}>Светлый фон (50)</Box>
      <Box bg="brand.100" p={4}>Очень светлый (100)</Box>
      <Box bg="brand.200" p={4}>Светлый (200)</Box>
      <Box bg="brand.300" p={4}>Средне-светлый (300)</Box>
      <Box bg="brand.400" p={4}>Средний (400)</Box>
      <Box bg="brand.500" p={4} color="white">Основной (500)</Box>
      <Box bg="brand.600" p={4} color="white">Средне-тёмный (600)</Box>
      <Box bg="brand.700" p={4} color="white">Тёмный (700)</Box>
      <Box bg="brand.800" p={4} color="white">Очень тёмный (800)</Box>
      <Box bg="brand.900" p={4} color="white">Самый тёмный (900)</Box>
    </Box>
  );
}
  ...
  return (
    <Box>
      ...
      <Box bg="accent.100" p={4} borderLeft="4px" borderColor="accent.500">
        <Heading size="md" color="accent.700">Акцентный заголовок</Heading>

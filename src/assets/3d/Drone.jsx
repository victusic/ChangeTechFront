  ...
  return (
    <group  {...props} dispose={null}>
      <group name="Sketchfab_Scene">
        <group name="Sketchfab_model" rotation={[-Math.PI / 2.365, 0, 0.4]} scale={0.35} ref={group}>
          <group name="Root">
            ...
            <group name="Circle002" position={[3.059, 2.733, 1.004]} rotation={[0, 0, 0.052]} scale={0.147}>
              <mesh name="Circle002_0" geometry={nodes.Circle002_0.geometry} material={materials.pale} />
            </group>
            <group name="Circle003" position={[-3.035, 2.754, 1.004]} rotation={[0, 0, -1.435]} scale={0.147}>
              <mesh name="Circle003_0" geometry={nodes.Circle003_0.geometry} material={materials.pale} />
            </group>
            <group name="Circle004" position={[-3.035, -2.19, 1.004]} rotation={[0, 0, -0.391]} scale={0.147}>
              <mesh name="Circle004_0" geometry={nodes.Circle004_0.geometry} material={materials.pale} />
            </group>
            <group name="Circle005" position={[3.047, -2.187, 1.004]} rotation={[0, 0, -1.36]} scale={0.147}>

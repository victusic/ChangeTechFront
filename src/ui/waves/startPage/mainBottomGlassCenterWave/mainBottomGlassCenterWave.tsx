...
export const MainBottomGlassCenterWave = ({...props}) => {
  return (
    ...
    <path d="M67.5 362.934C26.8257 392.697 0 472.934 0 472.934H1486V0C1486 0 1441.5 6 1360.5 62.5C1284.19 115.729 1269 168 1207.5 245C1134.3 336.649 1078 384.5 950.5 397.5C834.261 409.352 767.916 384.3 659 342C592.647 316.231 495 257.5 495 257.5C487.5 263 457.515 285.656 431 299.434C335.156 349.236 221.5 317.934 156 328.934C119.329 335.093 97.509 340.975 67.5 362.934Z" className={styles.back} fill-opacity="0.15"/>
    </g>
      <defs>
          <filter id="filter0_b_120_198" x="-4" y="-4" width="1494" height="480.934" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
